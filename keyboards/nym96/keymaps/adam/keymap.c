...
|              |        |        |        |        |        |        |        |        |        |        |   '    |                    |        |        |        |   +    |
|   CAPS LOCK  |   A    |   R    |   S    |   T    |   D    |   H    |   N    |   E    |   I    |   O    |   "    |       ENTER        |   4    |   5    |   6    |        |
...
|                  |        |        |        |        |        |        |        |   ,    |    .   |   /    |                |        |        |        |        |        |
|      SHIFT       |   Z    |   X    |   C    |   V    |   B    |   K    |   M    |   <    |    >   |   ?    |     SHIFT      |   UP   |   1    |   2    |   3    |        |
...
*/
    ...
    KC_CAPS, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
    KC_LSPO,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,          KC_UP,   KC_P1,   KC_P2,   KC_P3,
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, TG(1),   MO(2),   KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT),
...
*/
    ...
    KC_TRNS, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
